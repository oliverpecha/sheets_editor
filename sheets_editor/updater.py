...
class SheetUpdater:
    ...
    def update_image_formulas_with_formatting(
            ...
            row_height: int = None,
            alignment: str = None,  # Change this to str
        ):
            """
            ...
            Args:
                ...
                alignment (str, optional): The desired alignment (LEFT, RIGHT, CENTER, or FLOAT). Defaults to None.
            ...
            Example:
                ...
                updater.update_image_formulas_extended(cell_updates, column_width=200, row_height=100, alignment="CENTER")
            ...
            if alignment is not None:
                alignment_enum = self.parse_alignment(alignment)  # Convert alignment string to enum
                self.set_cell_alignment(cell_updates, alignment_enum)
