...
class SheetUpdater:
    ...
    def update_image_formulas_extended(
        self,
            ...
            "requests": [
                {
                    "updateCell": {
                        ...
                        "cell": {
                            "userEnteredFormat": {
                                "horizontalAlignment": "CENTER" if alignment_value == "FLOAT" else alignment_value, #if alignment is set to FLOAT, both horizontal and vertical alignment become center
